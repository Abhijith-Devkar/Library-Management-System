...
INSERT INTO branch1(branch_id, manager_id, branch_address, contact_no) 
VALUES
...
INSERT INTO employees1(emp_id, emp_name, position, salary, branch_id) 
VALUES
...
INSERT INTO members1(member_id, member_name, member_address, reg_date) 
VALUES
...
(
            ...
            FOREIGN KEY (issued_member_id) REFERENCES members1(member_id),
            FOREIGN KEY (issued_emp_id) REFERENCES employees1(emp_id),
            FOREIGN KEY (issued_book_isbn) REFERENCES books1(isbn) 
);

INSERT INTO issued_status1(issued_id, issued_member_id, issued_book_name, issued_date, issued_book_isbn, issued_emp_id) 
VALUES
...
(
            ...
            FOREIGN KEY (return_book_isbn) REFERENCES books1(isbn)
);

INSERT INTO return_status1(return_id, issued_id, return_date) 
VALUES
...
CREATE TABLE books_price_greater_than_seven1
AS    
SELECT * FROM Books1
WHERE rental_price > 7;

SELECT * FROM 
books_price_greater_than_seven1;
